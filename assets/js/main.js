jQuery(document).ready(function ($) {
  ...
  fixSpaceTabSlick(
    $('.product-tab-slide .nav-tabs li[class*="active"] > a').attr(
      "aria-controls"
    )
  );
    ...
    $('[data-countdown="countdown"]').each(function (index, el) {
      ...
      $this.ENGO_CountDown({
        TargetDate:
          ...
          $date[5],
        DisplayFormat:
          "<li><p>%%D%% <span>:</span> </p><span>days</span></li><li><p>%%H%% <span>:</span></p><span>hrs</span></li><li><p>%%M%% <span>:</span> </p><span>mins</span></li><li><p>%%S%% </p><span>secs</span></li>",
        FinishMessage: "Expired",
      });
    });
  }
    ...
    $('[data-countdown="countdown_prd"]').each(function (index, el) {
      ...
      $this.ENGO_CountDown({
        TargetDate:
          ...
          $date[5],
        DisplayFormat:
          "<li><p>%%D%% <span>:</span> </p></li><li><p>%%H%% <span>:</span></p></li><li><p>%%M%% <span>:</span> </p</li><li><p>%%S%% </p></li>",
        FinishMessage: "Expired",
      });
    });
  }
